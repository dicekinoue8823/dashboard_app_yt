...
import {HiArrowSmallUp, HiArrowLongDown, HiArrowSmallDown} from "react-icons/hi2";
    ...
    return (
      <main>
        <div className="flex items-center">
          <div className="h-[250px] w-[350px] shadow-md">
            <span className="flex font-semibold items-center justify-center text-xl cursor-pointer mt-10 text-red-500">
              Revenue
            </span>
            ...
            <div>
              <div className="flex items-center justify-center mt-3">
                ...
                <HiArrowSmallDown className="text-3xl text-red-700"/>
              </div>
              <div className="flex items-center justify-center mt-3">
